...
INSTALLED_APPS = [
    ...
    "django.contrib.messages", "django.contrib.staticfiles", "rest_framework", "django_filters", "corsheaders",
    "simple_history", "accounts", "incidents", "dispatches", "etc_claims", "audit",
]
MIDDLEWARE = [
...
if DATABASE_URL:
    DATABASES = {"default": dj_database_url.parse(DATABASE_URL, conn_max_age=0, conn_health_checks=True, ssl_require=not DEBUG)}
else:
